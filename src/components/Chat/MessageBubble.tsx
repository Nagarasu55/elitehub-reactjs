...
interface Props {
    ...
    // ✅ NEW: true while message is optimistic (not yet confirmed by server)
}
    ...
    return (
        <>
            ...
            <Modal
                ...
                onOk={() => {
                    if (deleteTarget === "for_me") onDeleteForMe(message.id);
                    else if (deleteTarget === "for_everyone") onDeleteForEveryone(message.id);
